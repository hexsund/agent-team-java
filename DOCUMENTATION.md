# Agent Team Java — Extension Documentation

**Agent Team Java** 是一个 pi coding agent 扩展，为 Java 企业级项目提供一个完整的 AI 软件工程团队。团队包含 **28 名专业 Agent** 和 **1 名 Manager 编排者**，覆盖从需求分析到运维复盘的全生命周期。
